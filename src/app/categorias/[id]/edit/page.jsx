...
export default function EditarCategoria() {
  ...
  useEffect(() => {
    if (id) getCategoria(id).then(c => setCategoria({ nombre: c.nombre }));
  }, [id]);
  ...
  return (
    <div className="max-w-lg mx-auto bg-white/95 rounded-2xl shadow-2xl border-2 border-blue-100 overflow-hidden p-8 mt-12 relative">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-extrabold text-red-700 tracking-tight mb-1 flex items-center justify-center gap-2">
          Editar Categoría
          <FaFolderOpen className="text-blue-400 ml-2" />
        </h1>
        <p className="text-blue-700/80 font-medium">Modifique los datos que desee actualizar</p>
      </div>
